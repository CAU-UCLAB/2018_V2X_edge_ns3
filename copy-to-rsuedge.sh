...
cp $NS3_APP_FOLDER/helper/rsu-app-helper.h $PROJECT_APP_FOLDER/model/
cp $NS3_APP_FOLDER/helper/rsu-app-helper.cc $PROJECT_APP_FOLDER/model/
cp $NS3_APP_FOLDER/helper/rsu-vehicle-helper.h $PROJECT_APP_FOLDER/model/
cp $NS3_APP_FOLDER/helper/rsu-vehicle-helper.cc $PROJECT_APP_FOLDER/model/
